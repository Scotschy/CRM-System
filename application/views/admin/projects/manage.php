            ...
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <a href="<?php echo admin_url('projects/gantt'); ?>" data-toggle="tooltip"
                        title="<?php echo _l('project_gant'); ?>" class="btn btn-default"><i class="fa fa-align-left"
                ...
                <div class="panel_s tw-mt-2 sm:tw-mt-4">
                  ...
                  foreach ($statuses as $status) {
                      ...
                      echo form_hidden('project_status_' . $status['id'], $value); ?>
                                <div
                                    class="col-md-2 col-xs-6 tw-border-r tw-border-solid tw-border-neutral-300 last:tw-border-r-0">
