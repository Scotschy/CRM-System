...
*
*/
define('APP_BASE_URL', 'http://panel.vlblum.de/');
...
*/
define('APP_ENC_KEY', '27ff105eebe3ba530be214b89c60dc37');
 ...
 */
define('APP_DB_USERNAME', 'vlblum');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '9!PNEbk%2rD@EkBA');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'panel');
